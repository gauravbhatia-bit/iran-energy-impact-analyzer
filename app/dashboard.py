...
def add_event_lines(fig, row=1, col=1):
    for date_str, (label, color) in KEY_EVENTS.items():
        fig.add_vline(
            x=date_str, line_dash="dash", line_color=color, line_width=1.5,
...
# ═══════════════════════════════════════════════════════════════════════
    ...
    **Methodology:** Standard financial event study — measures *abnormal* price movements
    ...
    fig.add_vline(x="2026-02-28", line_dash="dash", line_color="#E74C3C",
                  annotation_text="Conflict Start", row=1, col=1)
...
# ═══════════════════════════════════════════════════════════════════════
    ...
    fig.add_vline(x="2026-05-01", line_dash="dot", line_color="#888",
